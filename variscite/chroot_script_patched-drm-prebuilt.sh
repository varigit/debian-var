...
dpkg -i libegl1-mesa_13.0.6-1~bpo8+1_armhf.deb libgbm1_13.0.6-1~bpo8+1_armhf.deb libgl1-mesa-dri_13.0.6-1~bpo8+1_armhf.deb libgl1-mesa-glx_13.0.6-1~bpo8+1_armhf.deb libglapi-mesa_13.0.6-1~bpo8+1_armhf.deb libgles2-mesa_13.0.6-1~bpo8+1_armhf.deb libwayland-egl1-mesa_13.0.6-1~bpo8+1_armhf.deb libxatracker2_13.0.6-1~bpo8+1_armhf.deb mesa-common-dev_13.0.6-1~bpo8+1_armhf.deb

...
readonly G_UBOOT_REV="83c3b6b7c0d6098774d59bbb5f226fa7aba89751"
...
readonly G_IMXBOOT_PATCHES="${G_VARISCITE_PATH}/${MACHINE}/imx-boot-tools/imx-boot/imx-mkimage-imx8m-soc.mak-add-dart-mx8m-support.patch"

#!/bin/bash
# It is designed to build Debian linux for Variscite var-som-mx7 modules
...
readonly G_LINUX_KERNEL_REV="625681c7723a06367fbe6270688968f08b0d3541"
...
readonly G_UBOOT_REV="0ad59ba42007bcca58efe0b6e9b4bb9fdd8487c5"
